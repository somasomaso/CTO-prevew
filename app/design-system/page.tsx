        ...
        <div className="space-y-16">
          <header>
            ...
            <div className="mt-6">
              <a
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-neon-purple/10 to-neon-blue/10 px-4 py-2 text-sm font-medium text-neon-purple transition-all hover:from-neon-purple/20 hover:to-neon-blue/20 border border-neon-purple/30"
              >
